...
<head>
    ...
    <link
      ...
      crossorigin="anonymous"
    />
    <title>Teacher Login | School Management Software</title>
</head>
<body class="bg-dark">
<div class="container-fluid p-5 pb-0 m-0 bg-dark pt-0 text-light">
<h3 class="pt-4 pb-3 text-center">Teacher Login</h3>
...
<form class="border border-warning border-5 rounded m-2 p-3" action="" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control bg-secondary" name="phnnum">
  </div>
