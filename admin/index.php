        ...
        <div class="row">
          <div class="card border-warning mb-3 bg-dark text-center" style="max-width: auto;">
            ...
            <div class="p-l card-body bg-dark">
              ...
              <p class="p-1 card-text">Click on login button to view records and manipulate data.</p>
  ...
  <div class="modal-dialog">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-warning" name="login1">Login</button></form>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-warning" name="login2">Login</button></form>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content bg-dark">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-warning" name="login3">Login</button></form>
      </div>
    </div>
  </div>
</div>                </div>
