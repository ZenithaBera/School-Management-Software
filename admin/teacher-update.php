...
<html lang="en">
  ...
  <?php include 'include_admin/top_links.php' ?>
    ...
    <title>Teacher Update | School Management Software</title>
  </head>
  <body>
    <div class="container-fluid bg-dark text-light overflow-hidden">
        ...
        <div class="row">
                ...
                <h3 class="navbar-brand justify-content-start fw-bold">Update</h3>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <nav class="nav flex-column" aria-label="">
                      ...
                      <a class="nav-link active bg-warning text-dark fw-bold" href="teacher-delete.php">For Admin Only</a>
          ...
          <!--Form-->
          <form action="teacherdb_upd.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-3 m-md-5 mt-md-0 mb-md-3 col-sm-12">
            ...
            <input type="text" class="form-control" name="dist" placeholder="Enter your district" id="exampleInputName1"  value="<?php echo $row['dist']; ?>" required>
          </div>
          <div class="col-md-3 m-md-5 mt-md-0 mb-md-3 col-sm-12">
