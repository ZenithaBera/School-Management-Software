        ...
        <div class="col-md-2 col-sm-12 sidepanel m-0 p-0 border border-warning">
            <nav>
              ...
              <a href="../dashboard/staff-dashboard.php" class="text-decoration-none fw-bold"><i class="fas fa-home"></i>&nbsp;&nbsp;&nbsp;Home</a>
                ...
                <a href="staff-delete.php" class="text-decoration-none fw-bold"><i class="fas fa-user-shield"></i>&nbsp;&nbsp;&nbsp;For Admin Only</a>
            </nav>
        </div>
      ...
      <form action="../php/staffdb_upd.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-md-3 m-md-5 mt-md-0 mb-md-3 col-sm-12">
            ...
            <input type="tel" class="form-control" name="mobnum" placeholder="e.g. 98XXXXXXXX" id="exampleInputName1" value="<?php echo $row['mobnum']; ?>"  required>
          </div>
          <div class="col-md-3 m-md-5 mt-md-0 mb-md-3 col-sm-12">
