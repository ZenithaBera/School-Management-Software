        ...
        <div class="col-md-2 col-sm-12 sidepanel m-0 p-0 border border-warning">
            <nav style="height: 100vh;">
              ...
              <a href="../dashboard/staff-dashboard.php" class="text-decoration-none fw-bold"><i class="fas fa-home"></i>&nbsp;&nbsp;&nbsp;Home</a>
                <a href="staff-register.php" class="text-decoration-none fw-bold"><i class="fas fa-sign-in-alt"></i>&nbsp;&nbsp;&nbsp;Registration</a>
                <a href="../dashboard-login/staff-login.php" class="text-decoration-none fw-bold"><i class="fas fa-user-circle"></i>&nbsp;&nbsp;&nbsp;Profile Details</a>
                <a href="staff-delete.php" class="active text-decoration-none bg-warning text-dark fw-bold"><i class="fas fa-user-shield"></i>&nbsp;&nbsp;&nbsp;For Admin Only</a>
            </nav>
        </div>
              ...
              <h3 class="navbar-brand justify-content-start fw-bold">Records</h3>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <nav class="nav flex-column" aria-label="">
                    ...
                    <a class="nav-link fw-bold" href="staff-register.php">Registration</a>
                    <a class="nav-link fw-bold" href="../dashboard-login/staff-login.php">Profile Details</a>
                    <a class="nav-link active bg-warning text-dark fw-bold" href="staff-delete.php">For Admin Only</a>
                  </nav>
                </div>
              </nav>
            </div>
