    ...
    <div class="container-fluid bg-dark text-light overflow-hidden">
        ...
        <div class="row">
          <div class="col-md-2 col-sm-12 sidepanel m-0 p-0 border border-warning">
              <nav>
                ...
                <a href="../dashboard/student-dashboard.php" class="text-decoration-none"><i class="fas fa-home"></i>&nbsp;&nbsp;&nbsp;Home</a>
        ...
        <div class="row">
          ...
          <div class="col-md-3 m-md-5 mt-md-0 mb-md-3 col-sm-12">
            ...
            <input type="text" class="form-control" name="aadhar" placeholder="e.g. 1111 2222 3333" id="exampleInputName1" value="<?php echo $row['aadhar']; ?>" disabledd>
          </div>
          <div class="col-md-3 m-md-5 mt-md-0 mb-md-3 col-sm-12">
